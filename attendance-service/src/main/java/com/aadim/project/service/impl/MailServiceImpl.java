...
public class MailServiceImpl implements MailService {
    ...
    @Async
    @Override
    public void sendHtmlMail(String to, String sub, LeaveRequest leaveRequest) throws MessagingException {
        ...
        context.setVariable("name", leaveRequest.getName());
        context.setVariable("position", leaveRequest.getPosition());
        context.setVariable("phone", leaveRequest.getPhone());
